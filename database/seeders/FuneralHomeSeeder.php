...
class FuneralHomeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($data as $index => $item) {
            ...
            $this->createImages($funeralHome, $item);
            $this->createReviews($funeralHome, $item);
        }

        $this->command->info('Import completed successfully!');
    }

    private function createFuneralHome(array $item): FuneralHome
    {
        $funeralHome = FuneralHome::query()
        ...
        return FuneralHome::query()->create([
            'title' => $item['title'],
    ...
    private function createCategories(FuneralHome $funeralHome, array $item): void
    {
    ...
    private function createOpeningHours(FuneralHome $funeralHome, array $item): void
    {
    ...
    private function createPeopleAlsoSearch(FuneralHome $funeralHome, array $item): void
    {
    ...
    private function createImages(FuneralHome $funeralHome, array $item): void
    {
    ...
    private function createReviews(FuneralHome $funeralHome, array $item): void
    {
